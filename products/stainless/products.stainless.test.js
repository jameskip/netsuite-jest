...
test('should not add Mug Stainless, Air Force Primary ', (done) => createOrder(done, '[data-select="rambler-mug-14oz"]', '[title="Shop College Logo Custom YETI Ramblers"]', '[data-key="air-force-primary-1"]'))
...
test('should not add Jug 64oz Stainless, Air Force Primary ', (done) => createOrder(done, '[data-select="rambler-jug-64oz"]', '[title="Shop College Logo Custom YETI Ramblers"]', '[data-key="air-force-primary-1"]'))

test('should not add Jug 128oz Stainless, Air Force Primary ', (done) => createOrder(done, '[data-select="rambler-jug-128oz"]', '[title="Shop College Logo Custom YETI Ramblers"]', '[data-key="air-force-primary-1"]'))
